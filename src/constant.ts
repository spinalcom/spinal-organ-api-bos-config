...
import { SPINAL_RELATION_LST_PTR_TYPE, SPINAL_RELATION_PTR_LST_TYPE, SPINAL_RELATION_TYPE } from "spinal-env-viewer-graph-service";
...
//              node names           //
///////////////////////////////////////
export const AVAILABLE_APPLICATIONS_CONTEXT_NAME = "Available Applications";
...
export const BOS_CREDENTIAL_CONTEXT_NAME = "BOSToAuthCredential";
...
// Error
const ERROR_PREFIX: string = 'BOS Admin Service App Error: ';
