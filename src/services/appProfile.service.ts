...
export class AppProfileService {
  ...
  public async getAppProfileNodeGraph(
    profileId: string,
  ...
  public async _getAppProfileNodeGraph(
    profileId: string
  ): Promise<SpinalGraph | void> {
    const profile = await this._getAppProfileNode(profileId);
