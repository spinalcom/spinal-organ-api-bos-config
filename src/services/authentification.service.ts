...
export class AuthentificationService {
	 ...
	 */
	public async getBosToAdminCredential(): Promise<IBosCredential | undefined> {
	...
	public async updateBosTokenInAuthPlatform(): Promise<{ token: string; code: number }> {
		...
		return axios
			.post(
				`${urlAdmin}/platforms/updatePlatformToken`,
				{ clientId, token: tokenBosToAdmin },
				{
	 ...
	 */
	public async getAdminCredential(): Promise<IAdminCredential | undefined> {
	 ...
	 */
	private async _getOrCreateAdminCredential(createIfNotExist: boolean = false): Promise<IAdminCredential | undefined> {
	...
	private _formatAppProfiles(): Promise<IAdminAppProfile[]> {
		return AppProfileService.getInstance()
