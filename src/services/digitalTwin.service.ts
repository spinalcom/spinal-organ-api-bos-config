...
export class DigitalTwinService {
	...
	private _actualDigitalTwin: SpinalNode | undefined;
	 ...
	 */
	public async getDigitalTwinGraph(digitalTwin: SpinalNode): Promise<SpinalGraph | undefined> {
		try {
	...
	public async getDigitalTwinContexts(digitalTwinId?: string): Promise<SpinalContext[]> {
		...
		const graph: SpinalGraph | undefined = await this.getDigitalTwinGraph(digitalTwin);
		if (!graph) return [];
	 ...
	 */
	public async findContextInDigitalTwin(digitalTwinId: string, contextId: string): Promise<SpinalContext | undefined> {
	 ...
	 */
	public async editDigitalTwin(digitalTwinId: string, newData: { name?: string; url?: string }): Promise<SpinalNode | undefined> {
	 ...
	 */
	public getActualDigitalTwin(createIfNotExist: boolean = false): Promise<SpinalNode | undefined> {
