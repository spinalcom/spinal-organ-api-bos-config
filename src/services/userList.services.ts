...
export class UserListService {
	 ...
	 */
	public async getUser(username: string): Promise<SpinalNode | undefined> {
	 ...
	 */
	public async createAdminUser(userInfo?: IUserInfo): Promise<SpinalNode | undefined> {
	 ...
	 */
	public async getAdminUser(userName: string): Promise<SpinalNode | undefined> {
